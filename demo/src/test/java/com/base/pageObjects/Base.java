...
<<<<<<< HEAD
    ...
    public void clicaBotao(WebDriver navegador) throws FindFailed {
        ...
        //buttonLogin.click();
=======
  Pattern botao = new Pattern(
      "D:\\Automation\\AutomationBase\\demo\\src\\test\\resources\\sikuliImages\\btnPermitir.jpg");
  Screen screen = new Screen();
...
>>>>>>> 8cd6645bb9a05becaadb787ff7a15dc44f692fba
    }
    util.WaitInSeconds(2);
  }
...
>>>>>>> 8cd6645bb9a05becaadb787ff7a15dc44f692fba
  ...
  public void ChecaValorAtualBitcoin(WebDriver navegador) {
    valorBitcoin = "";
    WebElement BitcoinTxt = navegador
        .findElement(By.xpath("//*[@id=\"products-showcase\"]/div[3]/div[4]/div/div/table/tbody/tr[1]/td[5]"));
